...
<body>
          ...
          <div class="col-sm-10 p-0">
              ...
              <div class="container-fluid">
                  <div class="btn mt-5 d-sm-flex justify-content-between">  
                          <div class="header">
                            <h1 class="text-danger"><i class="fas fa-users px-3"></i>Business Permit</h1>
                          </div>
                          <div class="button">
                          <input type="text" placeholder="Search" id="myInput" class="form-control mb-3">
                          <button data-bs-toggle="modal" data-bs-target="#addbusiness_permit" class="btn btn-danger btn-lg"><i class="fas fa-plus"></i>Add New</button> 
                    ...
                    <table class="table table-striped text-center">
                      ...
                      <!-- DISPLAY DATA FROM DATABASE -->
                    	<?php
                            ...
                            $query=mysqli_query($conn,"SELECT * from `tblbusiness_permit`");
                            ...
                            while($row=mysqli_fetch_array($query)){
                              ...
                              <tr">
                                ...
                                <button data-bs-toggle="modal" data-bs-target="#editbusiness_permit<?php echo $row['id'];?>" class="btn btn-warning"><i class="fas fa-edit"></i>Update</button> 
                                <button data-bs-toggle="modal" data-bs-target="#del-business_permit<?php echo $row['id']; ?>" class="btn btn-danger"><i class="fas fa-trash-alt"></i>Delete</button> 
                                <button data-bs-toggle="modal" data-bs-target="#view-permit<?php echo $row['id']; ?>" class="btn btn-primary"><i class="fas fa-eye"></i>View</button> 
                                <?php include('edit-del-business_permit.php'); ?>
                                <?php include('view-permit.php'); ?>
                                </td>
    ...
    <?php include('add_business_permit.php'); ?>
