 <!-- MODAL ADD RECORD -->
 <div class="modal fade" id="editresident<?php echo $row['id']; ?>"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
          <div class="modal-content">
            ...
            <div class="modal-body">
                <?php
                    $edit = mysqli_query($conn,"SELECT * FROM tblresident WHERE id='".$row['id']."'");
                    $erow = mysqli_fetch_array($edit);
                ?>

                <div class="mt-3">
                  <form action="edit-resident.php?id=<?php echo $erow['id']; ?>" method="POST">
                        ...
                        <div class="row">
                          <div class="col-sm-12 mt-3">
                            ...
                            <input type="text" class="form-control" placeholder="Address" name="address" value="<?php echo $erow['Address']; ?>" required>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-sm-6 mt-3">
                            ...
                            <input type="text" class="form-control" placeholder="Contact" name="contact" value="<?php echo $erow['ContactNumber']; ?>" required>
                          </div>

                          <div class="col-sm-6 mt-3">
                            <label for="position" class="form-label">Gender</label>
                              <select class="form-select" id="sel1" name="gender" required>
                                <option><?php echo $erow['Gender'];?></option>
                                <option>Male</option>
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-6 mt-3">
                            ...
                            <input type="date" class="form-control" placeholder="End of Term" name="birthday" value="<?php echo $erow['Birthday']; ?>" required>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-sm-12 mt-3">
                            ...
                            <input type="email" class="form-control" placeholder="Email" name="email" value="<?php echo $erow['Email']; ?>" required>
                        </div>
         ...
         <!-- DELETE -->
         <div class="modal fade " id="del-resident<?php echo $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
				<?php
					$del=mysqli_query($conn,"SELECT * FROM tblresident WHERE id='".$row['id']."'");
...
<!--View -->
<div class="modal fade " id="view-resident<?php echo $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                <?php
                    $view=mysqli_query($conn,"SELECT * FROM tblresident WHERE id='".$row['id']."'");
