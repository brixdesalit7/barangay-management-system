...
// start session
session_start();
// check if session varible is set
...
<head>
    ...
    <title>Complaints | Barangay Management System</title>
          ...
          <div class="col-sm-10 p-0">
              ...
              <div class="container-fluid">
                  <div class="btn mt-5 d-sm-flex justify-content-between">  
                          <div class="header">
                            <h1 class="text-danger"><i class="fas fa-users px-3"></i>Complaints</h1>
                          </div>
                          <div class="button">
                          <input type="text" placeholder="Search" id="myInput" class="form-control mb-3">
                          <button data-bs-toggle="modal" data-bs-target="#addcomplaints" class="btn btn-danger btn-lg"><i class="fas fa-plus"></i>Add New</button> 
                    ...
                    <table class="table table-striped text-center">
                      ...
                      <!-- DISPLAY DATA FROM DATABASE -->
                    	<?php
                            ...
                            $query=mysqli_query($conn,"select * from `tblcomplaints`");
                            ...
                            while($row=mysqli_fetch_array($query)){
                              ...
                              <tr">
                                ...
                                <td><?php echo ($row['Apellant']); ?></td>
                                <td><?php echo ($row['Complaint']); ?></td>
                                <td><?php echo ($row['Status']); ?></td>
                                <td>
                                <!-- PASS THE ID TO MODAL TO GET THE SPECIFIC COLUMN FROM DATABASE -->
                                <button data-bs-toggle="modal" data-bs-target="#editcomplaint<?php echo $row['id'];?>" class="btn btn-warning"><i class="fas fa-edit"></i>Update</button> 
                                <button data-bs-toggle="modal" data-bs-target="#del-complaint<?php echo $row['id']; ?>" class="btn btn-danger"><i class="fas fa-trash-alt"></i>Delete</button> 
                                <button data-bs-toggle="modal" data-bs-target="#view-complaint<?php echo $row['id']; ?>" class="btn btn-primary"><i class="fas fa-eye"></i>View</button> 
                                <?php include('edit-del-complain.php'); ?>
                                </td>
