...
<head>
    ...
    <title>Zone List | Barangay Management System</title>
          ...
          <div class="col-sm-10 p-0">
              ...
              <div class="container-fluid">
                  <div class="btn mt-5 d-sm-flex justify-content-between">  
                          <div class="header">
                            <h1 class="text-danger"><i class="fas fa-users px-3"></i>Zone</h1>
                          </div>
                          <div class="button">
                          <button data-bs-toggle="modal" data-bs-target="#addzone" class="btn btn-danger btn-lg"><i class="fas fa-plus"></i>Add New</button> 
                          <?php include('addzone.php'); ?>
                          </div>
                  </div>
              </div>
              <div class="container-fluid">
                    <h3 class="mt-3 text-center">Zone List</h3>
                        <div class="row">
                          <div class="col-md-12">
                            ...
                            <table class="table table-striped text-center">
                              ...
                              <?php
                                    ...
                                    $query=mysqli_query($conn,"select * from `tblzone_list`");
                                    ...
                                    while($row=mysqli_fetch_array($query)){
                                      ...
                                      <tr">
                                        ...
                                        <button data-bs-toggle="modal" data-bs-target="#delzone-list<?php echo $row['id']; ?>" class="btn btn-danger"><i class="fas fa-trash-alt"></i>Delete</button> 
                                        <?php include('del-zonelist.php'); ?>
                                        </td>
