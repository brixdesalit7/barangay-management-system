                  ...
                  <form action="save-business_permit.php" method="POST">
                        ...
                        <div class="row">
                          <div class="col-sm-12 mt-3">
                            ...
                            <input type="text" class="form-control" placeholder="Contact" name="type_business" required>
                          </div>
                          <div class="col-sm-12 mt-3">
                            <label for="name" class="form-label">TIN Number:</label>
                            <input type="text" class="form-control" placeholder="Contact" name="tin" required>
                          </div>
                        </div>
